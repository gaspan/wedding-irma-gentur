      ...
      {active && (
        ...
        >
          ...
          >
            ...
            >
              <img src="/castle_bg.jpg" alt="Heavenly Castle Background" className="h-full w-full object-cover object-center" />
            </motion.div>
          ...
          >
            <img src="/sakura_left.png" alt="Sakura Branch Left" className="h-full w-auto max-w-none" />
          </motion.div>
          ...
          >
            <img src="/sakura_right.png" alt="Sakura Branch Right" className="h-full w-auto max-w-none" />
          </motion.div>
